...
(function loadReportingModule(){
  if (!document.querySelector('link[data-tss-reports]')) {
    ...
    css.rel = 'stylesheet';
    css.href = 'reports-activity.css?v=20260907-interview-hydration-v14';
    css.dataset.tssReports = '1';
    document.head.appendChild(css);
  }
  if (!document.querySelector('script[data-tss-reports]')) {
    const script = document.createElement('script');
    script.src = 'reports-activity.js?v=20260907-interview-hydration-v14';
    script.async = false;
    ...
    script.onload = () => {
      if (!document.querySelector('script[data-tss-daily-activity]')) {
        ...
        daily.src = 'reports-daily-activity.js?v=20260907-interview-hydration-v14';
        daily.async = false;
...
window.addEventListener('load', () => {
  const BUILD = '20260907-interview-hydration-v14';
  const addCss = (href) => {
